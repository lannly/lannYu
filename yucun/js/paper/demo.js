...
$(function(){
    ...
    PictureEdit.prototype.upload = function(){
        ...
        $uploadBtn.change(function(){
            var $uploadBtnWrap = $(this).parent(".J_file_wrap");
            that.uploadBtnWrap = $uploadBtnWrap;
            var $preImg = $(this).parents(".imgUpload").find(".J_file_box_img");
            that.preImg = $preImg;
    ...
    PictureEdit.prototype.addPics = function(){
        var thumb = $('<div class="itemPic"><i></i></div>'),
            key = this.getFileKey(),
            data = '';
    ...
    PictureEdit.prototype.delPics = function(){
        ...
        that.imageWrap.on('click','i',function(){
            var parent = $(this).parent('.itemPic'),
                key = parent.attr('key');
            parent.remove();
